...
Dataset: https://www.kaggle.com/datasets/pavansubhasht/ibm-hr-analytics-attrition-dataset/data This project contains a full SQL workflow built using the HR Employee Attrition dataset.
